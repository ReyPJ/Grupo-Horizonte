            ...
            >
                ...
                <div className="lg:hidden relative max-w-md mx-auto">
                    ...
                    <div className="px-10 space-y-4">
                        {/* Imagen compacta */}
                        <div className="w-full">
                            <div className="company-image rounded-xl overflow-hidden shadow-lg ring-1 ring-black/5">
                                <Image
                    ...
                    <div className="flex-1 min-w-0">
                        <div className="flex flex-col">
                            <div className="flex flex-row items-center justify-center gap-12">
                                <div className="logo-container w-1/2 max-w-[380px]">
                                    <Image
                                        src={companies[current].logoUrl}
                                        alt={companies[current].company}
                                        width={800}
                    ...
                    <div className="flex-shrink-0 flex justify-center">
                        <div className="company-image rounded-4xl overflow-hidden shadow-2xl ring-1 ring-black/5">
                            <Image
                                ...
                                width={1200}
                                height={1200}
                                className="w-full max-w-[520px] h-[700px] object-cover"
                            />
                        </div>
                    </div>
                </div>
